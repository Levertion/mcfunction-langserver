...
},{"../../brigadier/errors":"lIyQ","../../misc-functions":"irtH"}],"CLfq":[function(require,module,exports) {
"use strict";
...
exports.jsonParser = {
    parse: (reader, info) => {
        ...
        service.doComplete(document, { line: 0, character: remaining.length }, jsonDocument).then(completionList => {
            if (completionList) {
...
},{"../../misc-functions":"irtH"}],"Td8d":[function(require,module,exports) {
"use strict";
...
const implementedParsers = {
    ...
    "minecraft:component": json_1.jsonParser,
...
},{"./brigadier":"7xRZ","./literal":"OX8H","./minecraft/block":"IZJ1","./minecraft/coordinates":"cUI8","./minecraft/item":"MBE2","./minecraft/json":"CLfq","./minecraft/lists":"ZBji","./minecraft/message":"o/51","./minecraft/namespace-list":"pM/l","./minecraft/resources":"mhMo","./minecraft/scoreboard":"0BRi"}],"aDYY":[function(require,module,exports) {
"use strict";
