...
describe("Calculate Data Folder (Misc)", () => {
    it("should find the datapacks folder of the file", () => {
        assert.equal(calculateDataFolder("/home/datapacks/pack/", "/"), "/home/datapacks/");
    });
    ...
    it("should not allow a datapacks file", () => {
        ...
        assert.equal(calculateDataFolder("/etc/datapacks/pack/data/datapacks", "/"), "/etc/datapacks/");
    });
    it("should allow a windows style path", () => {
        assert.equal(calculateDataFolder("C:\\\\whatever\\datapacks\\pack\\data", "\\"), "C:\\\\whatever\\datapacks\\");
    });
});
