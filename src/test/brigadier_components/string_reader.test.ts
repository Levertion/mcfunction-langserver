  ...
  describe("readInt()", () => {
    [1, 2, 3, 4, 5].forEach((val: number) => {
      it(`should read a ${val} character long integer`, () => {
        ...
        if (assertReturn(result, true, [], [])) {
          assert.strictEqual(result.data, Number.parseInt(numbers.join("")));
        }
      });
    });
    ...
    it("should throw an error when there is no integer under the cursor", () => {
      ...
      assertReturn(
        result,
        false,
        [{ code: "parsing.int.expected", range: { start: 0, end: 5 } }],
        []
      );
    });
  });
  describe("readFloat()", () => {
    ...
    it("should throw an error when there is no integer under the cursor", () => {
      ...
      assertReturn(
        result,
        false,
        [{ code: "parsing.float.expected", range: { start: 0, end: 7 } }],
        []
      );
    });
  });
  ...
  describe("readQuotedString()", () => {
    ...
    it("should throw an error if there is no opening quote", () => {
      ...
      assertReturn(
        result,
        false,
        [{ code: "parsing.quote.expected.start", range: { start: 0, end: 4 } }],
        []
      );
    });
  ...
  describe("readBoolean()", () => {
    ...
    it("should throw an error if not a boolean", () => {
      ...
      assertReturn(
        result,
        false,
        [{ code: "parsing.bool.invalid", range: { start: 0, end: 10 } }],
        []
      );
    });
  });
