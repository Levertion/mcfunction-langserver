...
const EXCEPTIONS = {
    BAD_CHAR: new CommandErrorBuilder("argument.nbt.longarray.badchar", "Expected ',' or ']', got '%s'"),
...
export class NBTTagLongArray extends NBTTag<NBTTagLong[]> {
    ...
    public parse(reader: StringReader) {
        ...
        const arrstart = reader.expect(ARRAY_START + LONG_ARRAY_PREFIX + ARRAY_PREFIX_SEP);
